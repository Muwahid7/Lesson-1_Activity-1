...
def open_calculator():
    ...
    Label(root, text="₹2000 notes:", bg='light grey').place(x=50, y=110)
    Label(root, text="₹500 notes:", bg='light grey').place(x=50, y=140)
    Label(root, text="₹100 notes:", bg='light grey').place(x=50, y=170)
    t1 = Entry(root)
